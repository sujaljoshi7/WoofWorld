...
const Contact = () => {
    ...
    try {
      ...
      try {
        await api.post(`/api/notifications/`, {
          message: `You have received a new query from ${fullName} and is waiting for your response.`,
          category: "Contact",
        });
      } catch (error) {
        console.log(error);
  ...
  useEffect(() => {
    // Show modal when submitted changes to true
    if (submitted) {
      // Wait for the DOM to render before accessing Bootstrap
  ...
  }, [submitted]); // Only run when submitted state changes
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12 col-md-10 col-lg-8">
                    <h5
                      className="display-5 mb-4 mb-md-5 mb-xl-8"
                      style={{ fontSize: "2rem" }}
                    >
                        ...
                        <div className="mb-4 mb-md-5">
                          ...
                          <div>
                            ...
                            <address className="m-0 text-secondary">
                              17, Silver Paw Complex, Near Dog Park, Vastrapur,
                            ...
                            <div className="mb-4 mb-sm-0">
                              ...
                              <div>
                                ...
                                <p className="mb-0">
                                  <a
                                    className="link-secondary text-decoration-none"
                                    href="mailto:contact@woofworld.com"
                                  >
                                    contact@woofworld.com
                                  </a>
                                </p>
                              </div>
                            </div>
