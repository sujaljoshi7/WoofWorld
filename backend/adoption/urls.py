...
from .views import BreedView,DogsView, activate_breed, deactivate_breed, activate_dog, deactivate_dog, GetSpecificDogData, increment_dog_views, AdoptionRequestView
...
urlpatterns = [
   ...
   path("adoption/<int:id>/", DogsView.as_view(), name="edit-dog"),
    ...
    path("adoption-request/", AdoptionRequestView.as_view(), name="deactivate_breed"),
]
